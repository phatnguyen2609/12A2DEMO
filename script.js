...
// Tạo nút Toggle Nhạc nền (Ban đầu bị ẩn)
...
// Tạo Gợi ý bật nhạc (Audio Prompt)
...
// Bắt tương tác đầu tiên của người dùng
...
function renderCards() {
    ...
    groups.forEach(groupNum => {
        ...
        // Gắn observer bắt sự kiện âm thanh
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    mm.add("(max-width: 768px)", () => {
        gsap.to(".cover-container", {
            scrollTrigger: { trigger: "body", start: "top top", end: "250px", scrub: 1 },
            height: "250px", ease: "none"
        });
    });
});
// ==========================================
